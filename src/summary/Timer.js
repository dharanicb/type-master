    ...
    return (
      <div className="time d-flex jcsb  aic p-2">
        <div className="d-flex aic">
          HH:
          <span className="text-lg">{this.appendZero(this.props.hours)}</span>
        </div>
        <div className="d-flex aic">
          MM:{" "}
          <span className="text-lg">{this.appendZero(this.props.minutes)}</span>
        </div>
        <div className="d-flex aic">
          SS :
          <span className="text-lg">{this.appendZero(this.props.seconds)}</span>
        </div>
      </div>
    );
  }
